...
import MergeTool from '@/components/merge/MergeTool';
...
export default function MergePage() {
  ...
  return (
    <div className="bg-[#0A0A0A] min-h-screen overflow-x-hidden text-white flex flex-col justify-between">
      ...
      <main className="relative z-10 flex-grow max-w-[600px] mx-auto w-full px-6 pt-[120px] pb-24 flex flex-col items-center">
        {/* Back button */}
        <button
        ...
        <div className="text-center mb-10 w-full">
          <div className="inline-flex items-center gap-2 bg-[rgba(245,82,12,0.1)] border border-[rgba(245,82,12,0.2)] rounded-full px-3.5 py-[5px] mb-5">
            ...
            <span className="text-[11px] font-semibold text-[#F5520C] tracking-[0.06em] uppercase">Merge PDF</span>
          </div>

          <h1 className="text-[clamp(24px,4vw,36px)] font-medium text-white tracking-[-0.02em] leading-[1.1] mb-3">
            Merge <GradientText>PDF Files</GradientText>
          </h1>
          <p className="text-[14px] text-[#9b9b9b] leading-[1.6]">
            Combine multiple PDFs into a single document in your browser. Fast, secure, and no installation required.
          </p>
        </div>
